<?php
	$adresa="2400 Vanderbilt Beach Rd. Unit #102 Naples,FL 34109"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2394039092;// Broj koji se poziva na dugme CALL US
